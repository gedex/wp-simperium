...
class WP_Simperium_Plugin {
	...
	public function run( $path ) {
		...
		$this->name    = 'wp_simperium'; // This maybe used to prefix options, slug of menu or page, and filters/actions.
		$this->version = '0.1.0';
		...
		// Instances.
		$this->config = new WP_Simperium_Config( $this );
