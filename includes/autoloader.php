...
class WP_Simperium_Autoloader {
	...
	public static function autoload( $classname ) {
		// simperium.php is a special class where its name matches entirely with
		// class_prefix.
		if ( self::$class_prefix === $classname ) {
			require self::$base_path . 'simperium.php';
		}
